...
var group = "batch.tutorial.kubebuilder.io"
...
func (r *CronJob) Default() {
	...
	if r.Spec.SuccuessfulJobsHistoryLimit == nil {
		r.Spec.SuccuessfulJobsHistoryLimit = new(int32)
		*r.Spec.SuccuessfulJobsHistoryLimit = 3
	}
...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: group, Kind: "CronJob"},
		r.Name, allErrs)
}
